...
const navigation = {
  ...
  support: [
    { name: "IT Certification", href: "#" },
    { name: "Careers", href: "#" },
    { name: "FAQ", href: "#" },
    { name: "Terms & Condition", href: "#" },
  ],
  company: [
    { name: "Front End Developer", href: "#" },
    { name: "Back End Developer", href: "#" },
    { name: "Quality Assurance", href: "#" },
    { name: "UI/UX Design", href: "#" },
  ],
  legal: [
    { name: "+62 856-4097-7356", href: "#" },
    { name: "consult@sagara.asia", href: "#" },
    { name: "South Jakarta and Bandung, Indonesia.", href: "#" },
  ],
  social: [
    {
      name: "Facebook",
